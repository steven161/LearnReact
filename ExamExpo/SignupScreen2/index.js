            ...
            <View style={styles.container}> 
                ...
                <View style={styles.inputContainer}>
                    <View style={styles.buttonContainer}>
                           <Button flex="1" title="Google" color="#EA4234" icon={<Icon name='logo-google' size={18} color='white'/>}></Button>
                           <View width={32}/> 
                           <Button flex="1" title="Facebook" color="#1878F3" icon={<Icon name='logo-facebook' size={18} color='white'/>}></Button> 
                    </View>
